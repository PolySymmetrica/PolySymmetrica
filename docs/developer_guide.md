...
| `$ps_vertex_neighbors_idx` | Neighbor vertex indices incident to the current vertex. Closed-manifold vertices use cyclic vertex-fan order anchored at the lowest neighbour index; boundary vertices use edge-scan order. |
